export interface ImageEdits {
  ...
  resizePosition: "centre" | "top" | "right top" | "right" | "right bottom" | "bottom" | "left bottom" | "left" | "left top"
  resizeKernel: "nearest" | "linear" | "cubic" | "mitchell" | "lanczos2" | "lanczos3"
  ...
  composite: {
    input: string
    blend: "clear" | "source" | "over" | "in" | "out" | "atop" | "dest" | "dest-over" | "dest-in" | "dest-out" | "dest-atop" | "xor" | "add" | "saturate" | "multiply" | "screen" | "overlay" | "darken" | "lighten" | "colour-dodge" | "colour-burn" | "hard-light" | "soft-light" | "difference" | "exclusion"
  ...
  affine: {
    ...
    interpolator: "nearest" | "bilinear" | "bicubic" | "nohalo" | "lbb" | "vsqbs"
    enabled: boolean
  }
  ...
  toColorspace: "srgb" | "rgb" | "cmyk" | "lab" | "b-w" | "grey16" | "rgb16" | "scrgb"
